...
for i in range(0, 6561):
    ...
    if listinput[0] == fixnumber and listinput[1] == fixnumber and listinput[2] == fixnumber:
        if listinput[3] != fixnumber:
            for j in range(0, 4):
                for k in range(0, 4):
                    for m in range(0, 4):
...
for i in range(0, 6561):
    listinput = [int(x) for x in str(rawinput[i])]
    if listinput[1] == fixnumber and listinput[2] == fixnumber and listinput[3] == fixnumber:
        if listinput[0] != fixnumber:
            for j in range(0, 4):
                for k in range(0, 4):
                    for m in range(0, 4):
                        operator1, fn1 = operators[j]
...
for i in range(0, 6561):
    listinput = [int(x) for x in str(rawinput[i])]
    if listinput[0] == fixnumber and listinput[2] == fixnumber and listinput[3] == fixnumber:
        if listinput[1] != fixnumber:
            for j in range(0, 4):
                for k in range(0, 4):
                    for m in range(0, 4):
                        operator1, fn1 = operators[j]
...
for i in range(0, 6561):
    listinput = [int(x) for x in str(rawinput[i])]
    if listinput[0] == fixnumber and listinput[1] == fixnumber and listinput[3] == fixnumber:
        if listinput[2] != fixnumber:
            for j in range(0, 4):
                for k in range(0, 4):
                    for m in range(0, 4):
                        operator1, fn1 = operators[j]
